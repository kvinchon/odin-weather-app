...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE;wEACsE;EACtE,SAAS;AACX;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,OAAO;EACP,aAAa;EACb,sBAAsB;EACtB,aAAa;EACb,SAAS;EACT,0BAA0B;AAC5B;;AAEA;EACE,OAAO;EACP,yBAAyB;EACzB,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,SAAS;EACT,aAAa;AACf;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;;EAET;IACE,YAAY;IACZ,iBAAiB;IACjB,YAAY;IACZ,6BAA6B;;IAE7B;MACE,WAAW;MACX,UAAU;IACZ;EACF;EACA;IACE,8BAA8B;IAC9B,8BAA8B;IAC9B,kBAAkB;IAClB,WAAW;IACX,iBAAiB;IACjB,eAAe;IACf,gBAAgB;EAClB;EACA;IACE,YAAY;EACd;AACF;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;;EAET;IACE,aAAa;IACb,sBAAsB;IACtB,SAAS;;IAET;MACE,eAAe;MACf,gBAAgB;IAClB;IACA;MACE,iBAAiB;MACjB;QACE,WAAW;MACb;IACF;EACF;EACA;IACE,aAAa;IACb,sBAAsB;IACtB,SAAS;EACX;EACA;IACE,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,kBAAkB;IAClB,uBAAuB;IACvB,mBAAmB;IACnB,aAAa;IACb,8BAA8B;IAC9B,iBAAiB;IACjB,gBAAgB;IAChB,WAAW;EACb;AACF;;AAEA;EACE,2BAA2B;EAC3B,WAAW;AACb;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;;EAEnB;IACE,qBAAqB;IACrB,aAAa;IACb,SAAS;IACT,SAAS;IACT,UAAU;IACV,iBAAiB;;IAEjB;MACE,gBAAgB;MAChB,YAAY;MACZ,UAAU;MACV,aAAa;MACb,eAAe;MACf,gBAAgB;MAChB,WAAW;MACX,qBAAqB;MACrB,2BAA2B;MAC3B,yBAAyB;IAC3B;IACA;MACE,WAAW;IACb;IACA;MACE,WAAW;MACX,0BAA0B;IAC5B;EACF;EACA;IACE,aAAa;IACb,mBAAmB;IACnB,SAAS;;IAET;MACE,YAAY;MACZ,WAAW;MACX,YAAY;MACZ,kBAAkB;MAClB,iBAAiB;IACnB;;IAEA;MACE,eAAe;IACjB;IACA;MACE,sBAAsB;MACtB,WAAW;IACb;IACA;MACE,YAAY;MACZ,WAAW;MACX,uBAAuB;MACvB,mBAAmB;MACnB,2BAA2B;IAC7B;EACF;AACF;;AAEA;EACE,aAAa;EACb,2DAA2D;EAC3D,SAAS;;EAET;IACE,mBAAmB;;IAEnB;MACE,WAAW;IACb;EACF;AACF;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,sBAAsB;EACtB,mBAAmB;EACnB,aAAa;EACb,UAAU;EACV,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;;EAET;IACE,iBAAiB;EACnB;EACA;IACE,aAAa;IACb,2DAA2D;IAC3D,SAAS;;IAET;MACE,aAAa;;MAEb;QACE,WAAW;MACb;MACA;QACE,iBAAiB;MACnB;MACA;QACE,eAAe;MACjB;MACA;QACE,aAAa;QACb,mBAAmB;QACnB,SAAS;;QAET;UACE,aAAa;UACb,YAAY;QACd;QACA;UACE,aAAa;UACb,sBAAsB;QACxB;MACF;IACF;EACF;AACF;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;EACZ,UAAU;;EAEV;IACE,WAAW;EACb;AACF","sourcesContent":["body {\n  font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto,\n    Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n  margin: 0;\n}\n\n.container {\n  display: grid;\n  grid-template-columns: 1fr 3fr;\n}\n\n.sidebar {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  padding: 64px;\n  gap: 32px;\n  background-color: lavender;\n}\n\n.content {\n  flex: 3;\n  background-color: #f6f6f8;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  gap: 32px;\n  padding: 64px;\n}\n\nform {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n\n  input {\n    height: 30px;\n    font-size: 1.1rem;\n    border: none;\n    background-color: transparent;\n\n    ::placeholder {\n      color: #000;\n      opacity: 1;\n    }\n  }\n  button {\n    background-color: mediumpurple;\n    border: 1px solid mediumpurple;\n    border-radius: 5px;\n    color: #fff;\n    padding: 8px 16px;\n    cursor: pointer;\n    font-weight: 700;\n  }\n  svg {\n    height: 30px;\n  }\n}\n\n.result {\n  display: flex;\n  flex-direction: column;\n  gap: 32px;\n\n  .current {\n    display: flex;\n    flex-direction: column;\n    gap: 32px;\n\n    .temp {\n      font-size: 5rem;\n      font-weight: 200;\n    }\n    .date {\n      font-size: 1.1rem;\n      .time {\n        color: gray;\n      }\n    }\n  }\n  .details {\n    display: flex;\n    flex-direction: column;\n    gap: 32px;\n  }\n  .location {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    text-align: center;\n    border: 1px solid black;\n    border-radius: 20px;\n    height: 100px;\n    background-color: mediumpurple;\n    font-size: 1.2rem;\n    font-weight: 700;\n    color: #fff;\n  }\n}\n\nhr {\n  border: 1px solid lightgray;\n  width: 100%;\n}\n\nheader {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n\n  ul {\n    list-style-type: none;\n    display: flex;\n    gap: 32px;\n    margin: 0;\n    padding: 0;\n    font-size: 1.2rem;\n\n    li button {\n      background: none;\n      border: none;\n      padding: 0;\n      font: inherit;\n      cursor: pointer;\n      outline: inherit;\n      color: gray;\n      text-decoration: none;\n      text-underline-offset: 10px;\n      transition-duration: 0.4s;\n    }\n    li button:hover {\n      color: #000;\n    }\n    .active {\n      color: #000;\n      text-decoration: underline;\n    }\n  }\n  .profile {\n    display: flex;\n    align-items: center;\n    gap: 12px;\n\n    button {\n      height: 40px;\n      width: 40px;\n      border: none;\n      border-radius: 50%;\n      font-size: 1.1rem;\n    }\n\n    button:hover {\n      cursor: pointer;\n    }\n    button.active {\n      background-color: #000;\n      color: #fff;\n    }\n    .avatar {\n      height: 50px;\n      width: 50px;\n      border: 1px solid black;\n      border-radius: 10px;\n      background-color: mistyrose;\n    }\n  }\n}\n\n.forecast {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(100px, 1fr));\n  gap: 12px;\n\n  .item {\n    align-items: center;\n\n    .minimal {\n      color: gray;\n    }\n  }\n}\n\n.hidden {\n  display: none;\n}\n\n.item {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  background-color: #fff;\n  border-radius: 10px;\n  padding: 24px;\n  z-index: 1;\n  height: 100px;\n}\n\n.today {\n  display: flex;\n  flex-direction: column;\n  gap: 24px;\n\n  .title {\n    font-size: 1.2rem;\n  }\n  .highlights {\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n    gap: 24px;\n\n    .item {\n      height: 150px;\n\n      .title {\n        color: gray;\n      }\n      .value {\n        font-size: 1.2rem;\n      }\n      .large {\n        font-size: 3rem;\n      }\n      .comment {\n        display: flex;\n        align-items: center;\n        gap: 12px;\n\n        svg {\n          fill: #ffd353;\n          height: 40px;\n        }\n        > div {\n          display: flex;\n          flex-direction: column;\n        }\n      }\n    }\n  }\n}\n\nfooter {\n  grid-column: 1 / 3;\n  grid-row: 2 / 3;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 50px;\n  z-index: 1;\n\n  a {\n    color: #000;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
  ...
  buttons.forEach((btn) => {
    btn.addEventListener('click', () => {
      ...
      degrees.forEach((degree) => {
        degree.textContent =
          btn.name === 'celsius'
            ? (0,_weather__WEBPACK_IMPORTED_MODULE_0__.convertToCelsius)(degree.textContent)
            : (0,_weather__WEBPACK_IMPORTED_MODULE_0__.convertToFahrenheit)(degree.textContent);
      });
...
function render(forecast, container) {
  forecast.forEach((timeline) => {
    ...
    if (container.id === 'daily') {
      dayTime.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(currentTime, 'E');
      ...
      maxDegrees.textContent = (0,_weather__WEBPACK_IMPORTED_MODULE_0__.round)(maxTemp);
      minDegrees.textContent = (0,_weather__WEBPACK_IMPORTED_MODULE_0__.round)(minTemp);
    } else {
      dayTime.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(currentTime, 'HH:mm');
...
form.addEventListener('submit', (e) => {
  ...
  (0,_weather__WEBPACK_IMPORTED_MODULE_0__.getWeather)(location).then((data) => {
    // render Sidebar info
    ...
    currentTemp.textContent =
      unit.name === 'celsius'
        ? (0,_weather__WEBPACK_IMPORTED_MODULE_0__.round)(data.current.temp_c)
        : (0,_weather__WEBPACK_IMPORTED_MODULE_0__.round)(data.current.temp_f);
    currentDay.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(data.current.last_updated, 'EEEE');
    currentTime.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(data.current.last_updated, 'p');
...
/* harmony export */ });
const key = "7a1d70bc6cec43c5826105902242103";
